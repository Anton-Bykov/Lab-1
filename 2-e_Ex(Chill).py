...
with open("adc_data_Anton_Spokoyniy.txt", "r") as file:
...
ax.set_title("\n".join(wrap('Артериальное давление в спокойном состоянии', 80)), fontsize = 25, pad = 20, loc = 'center')
...
#сохранение
fig.savefig('rest-pressure-Chill.png')