...
ax.set_title("\n".join(wrap('Пульс в спокойном состоянии', 40)), fontsize = 30, pad = 20, loc = 'center')
...
ax.plot(data_time[:-1], data, c='orange', linewidth=1, label ='Пульс - 71 [уд/мин]')
...
#сохранение
fig.savefig('rest-pulse-Chill.png')